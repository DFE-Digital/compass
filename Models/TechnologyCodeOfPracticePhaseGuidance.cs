...
/// <summary>
/// Guidance for applying a Technology Code of Practice point at a specific Agile phase
/// </summary>
public class TechnologyCodeOfPracticePhaseGuidance
{
    [Key]
    ...
    /// <summary>
    /// The Technology Code of Practice point this guidance applies to
    /// </summary>
    [Required]
    public int TechnologyCodeOfPracticeId { get; set; }

    [ForeignKey(nameof(TechnologyCodeOfPracticeId))]
    public virtual TechnologyCodeOfPractice TechnologyCodeOfPractice { get; set; } = null!;
