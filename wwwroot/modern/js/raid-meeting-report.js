/**
 * RAID meeting report — section order (localStorage) and edit-view reorder UI.
 */
(function () {
  'use strict';

  var STORAGE_KEY = 'compass.rr.sectionOrder.v1';
  var DEFAULT_ORDER = [
    'overview',
    'review',
    'risks',
  ...
  function getItemsContainer() {
    return document.querySelector('#rr-report-sections .dfe-f-toggle-group__items');
  }
  ...
  function init() {
    var layout = document.getElementById('rr-report-layout');
    var reportGroup = document.getElementById('rr-report-sections');
    var orderPanel = document.getElementById('rr-report-order-panel');
    var orderList = document.getElementById('rr-report-order-list');
    var editBtn = document.getElementById('rr-report-edit-view');
    var saveBtn = document.getElementById('rr-report-order-save');
    var cancelBtn = document.getElementById('rr-report-order-cancel');
    var resetBtn = document.getElementById('rr-report-order-reset');
    ...
    if (resetBtn) {
      resetBtn.addEventListener('click', function () {
        ...
        currentOrder = normalizeOrder(DEFAULT_ORDER.slice(), knownIds);
        draftOrder = currentOrder.slice();
        applyOrderToDom(currentOrder);
        renderOrderList();
      });
