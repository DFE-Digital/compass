...
{
    /// <inheritdoc />
    public partial class AddStatementTemplates : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StatementTemplates_CreatedAt",
                table: "StatementTemplates",
                column: "CreatedAt");

            migrationBuilder.CreateIndex(
                name: "IX_StatementTemplates_IsActive",
                table: "StatementTemplates",
                column: "IsActive");

            migrationBuilder.CreateIndex(
                name: "IX_StatementTemplates_Name",
                table: "StatementTemplates",
                column: "Name");

            migrationBuilder.CreateIndex(
                name: "IX_StatementTemplates_Name_Version",
                table: "StatementTemplates",
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: false),
                    PermissionKey = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserRoleAssignments_UserEmail",
                table: "UserRoleAssignments",
                column: "UserEmail");

            migrationBuilder.CreateIndex(
                name: "IX_UserRoleAssignments_UserEmail_RoleId",
                table: "UserRoleAssignments",
