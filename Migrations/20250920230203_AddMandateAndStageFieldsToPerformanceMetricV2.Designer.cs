...
namespace FipsReporting.Migrations
{
    ...
    [Migration("20250920230203_AddMandateAndStageFieldsToPerformanceMetricV2")]
    partial class AddMandateAndStageFieldsToPerformanceMetricV2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FipsReporting.Data.Objective", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("FipsReporting.Data.PerformanceMetric", b =>
                {
                    ...
                    b.Property<bool>("StageA")
                        .HasColumnType("INTEGER");

                    b.Property<bool>("StageB")
                        .HasColumnType("INTEGER");

                    b.Property<bool>("StageD")
                        .HasColumnType("INTEGER");

                    b.Property<bool>("StageL")
                        .HasColumnType("INTEGER");

                    b.Property<bool>("StageR")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("FipsReporting.Data.Milestone", b =>
                {
                    b.HasOne("FipsReporting.Data.Objective", "Objective")
                        .WithMany("Milestones")
